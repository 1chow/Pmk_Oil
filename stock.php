...
if(isset($_POST["DeleteItem"]) && intval($_POST["DeleteItem"])){ // delete employerr
    ...
    // check code
    $sqlCheck="select ProductID from ".$db_name.".products where ProductID!=".intval($_POST["UpdateProd"])." and Code='".mysql_real_escape_string(trim($_POST["Code"]))."' and Deleted=0 and Special=0;";
    ...
    // check name
    $sqlCheck="select ProductID from ".$db_name.".products where ProductID!=".intval($_POST["UpdateProd"])." and Name='".mysql_real_escape_string(trim($_POST["ProductName"]))."' and Deleted=0 and Special=0;";
    $rsCheck=mysql_query($sqlCheck);
    $Check=mysql_fetch_row($rsCheck);
    if($Check[0]){
    ...
    if(intval($_POST["UpdateProd"])>0){
        ...
        $sqlInsert="INSERT INTO ".$db_name.".products (Code, Name, Type, Vat, AvgCost, SellPrice, UseFor, CarType, Note, UnitNameID, UnitUsed, CanInvoice) VALUES ('".mysql_real_escape_string(trim($_POST["Code"]))."', '".mysql_real_escape_string(trim($_POST["ProductName"]))."', '".$_POST["Type"]."', 0, '".floatval($_POST["AvgCost"])."', '".floatval($_POST["SellPrice"])."', '".$_POST["UseFor"]."', '".$_POST["CarType"]."', '".mysql_real_escape_string(trim($_POST["ProductNote"]))."', ".intval($_POST["UnitName"]).", ".floatval($_POST["UnitUsed"]).", ".intval($_REQUEST["CanInvoice"]).");";
...
else if(isset($_REQUEST['transferSuccess']) && intval($_REQUEST["transferSuccess"])){
    $alertTxt='<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>บันทึกข้อมูลการเบิกสินค้าเรียบร้อยแล้ว.</div>';
}
...
if(isset($_REQUEST["UpdateItem"]) && intval($_REQUEST["UpdateItem"])){
    $sqlProduct="SELECT ProductID, Code, Name, AvgCost, SellPrice, Type, UseFor, Note, CarType, UnitNameID, UnitUsed, NoVatQTY, CanInvoice from ".$db_name.".products where Deleted=0 and ProductID=".intval($_REQUEST["UpdateItem"])." and Special=0 order by Code ASC";
        ...
        <div class="content-center">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="productInfo" action="stock.php" method="post" class="form-horizontal" role="form" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="form-group" style="clear:both;">
                            ...
                            <div class="radio col-lg-2">
                                <label>
                                    <input type="radio" name="Type" value="สินค้า"<?php 
                                    if($Product[5]!='บริการ')
                                        { print(" checked");
                                         } 
                                    ?>>
                            ...
                            <div class="radio col-lg-2">
                                <label>
                                    <input type="radio" name="Type" value="บริการ"<?php 
                                    if($Product[5]=='บริการ')
                                        { print(" checked"); 
                                } 
                                    ?>>
                                    ...
                                    function translatemoney() {
                                        var r=document.getElementsByName("Type");
                                            for(i=0;i<r.length;i++){
                                                if(r[i].checked==true){
                                                    var category=r[i].value;
                                                  }
                                            }
                                        var x = document.getElementById("SellPrice").value;
                                        if (category=="สินค้า") {
                                        document.getElementById("SellPriceNovat").value = number_format(x*0.93,2);
                                      }
                                        else{
                                        document.getElementById("SellPriceNovat").value = number_format(x,2);
                                      }
                                    }
                            </script>
                            <div class="col-sm-3">
                                <input type="text" class="form-control price" id="SellPrice" placeholder="ราคาขาย" value="<?php if($Product[1]){ print(number_format($Product[4], 2)); } ?>" style="width:100px;" onchange="translatemoney()">
                                <input type="text" class="form-control price" id="SellPriceNovat" placeholder="ราคาขายไม่Vat" value="<?php if($Product[1])if($Product[5]=='สินค้า'){ print(number_format($Product[4]*0.93, 2)); }else { print(number_format($Product[4], 2)); } ?>" style="width:100px;" readonly>
                             </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <script>
                                    function translatemoney2() {
                                        ...
                                        var x = document.getElementById("AvgCost").value;
                                         if (category=="สินค้า") {
                                        document.getElementById("AvgCostNovat").value = number_format(x*0.93,2);
                                      }
                                        else{
                                        document.getElementById("AvgCostNovat").value = x;
                                      }
                                    }
                            </script>
                            <div class="col-sm-3">
                                <input type="text" class="form-control price" id="AvgCost" placeholder="ราคาทุน" value="<?php if($Product[1]){print(number_format($Product[3], 2)); } ?>" style="width:100px;" onchange="translatemoney2()">
                                <input type="text" class="form-control price" id="AvgCostNovat" placeholder="ราคาทุนไม่Vat" value="<?php if($Product[1])if($Product[5]=='สินค้า'){ print(number_format($Product[3]*0.93, 2)); }else { print(number_format($Product[3], 2)); } ?>" style="width:100px;" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">ใช้สำหรับ:</label>
                            <div class="radio col-lg-2">
                                <label>
                                    <input type="radio" name="UseFor" value="บริการล้างรถ"<?php if(($Product[6]=='บริการล้างรถ') || $Product[5]==''){ print(" checked"); } ?>>
                                    บริการล้างรถ
                                </label>
                            </div>
                            <div class="radio col-lg-2">
                                <label>
                                    <input type="radio" name="UseFor" value="ถ่ายน้ำมันเครื่อง"<?php if($Product[6]=='ถ่ายน้ำมันเครื่อง'){ print(" checked"); } ?>>
                                    ถ่ายน้ำมันเครื่อง
                                </label>
                            </div>
                            <div class="radio col-lg-2">
                                <label>
                                    <input type="radio" name="UseFor" value="ทั้งหมด"<?php if($Product[6]=='ทั้งหมด'){ print(" checked"); } ?>>
                                    ทั้งหมด
                                </label>
                            </div>
                        </div>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="radio col-lg-2">
                                <label>
                                    <input type="radio" name="UseFor" value="อื่นๆ"<?php if($Product[6]=='อื่นๆ'){ print(" checked"); } ?>>
                                    อื่นๆ
                                </label>
                            </div>
                        </div> -->
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">ประเภทรถ:</label>
                            <div class="radio col-lg-2">
                                <select name="CarType" class="form-control input-sm">
                                <?php
                        ...
                        <div class="col-md-12">
                            ...
                            <div role="toolbar" class="btn-toolbar padding-bootom">
                                <div id="-1" class="btn-group">
                                    <button class="btn btn-success editItem" type="button"><i class="fa fa-plus"></i> เพิ่มสินค้า/บริการ</button>
                                    <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                </div>
                                <div class="btn-group">
                                    <button class="btn btn-info" type="button" onclick="location.href='stock-import.php?page=<?php print($_REQUEST['page']); ?>&back=stock';"><i class="fa fa-mail-forward"></i> ซื้อสินค้าเข้าสต็อก</button>
                                    <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                </div>
                                <div class="btn-group">
                                    <button class="btn btn-primary" type="button" onclick="location.href='stock-transfer.php?page=<?php print($_REQUEST['page']); ?>';"><i class="fa fa-arrows-h"></i> เบิกสินค้า</button>
                                    <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                </div>
                                <div class="btn-group">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="stock-report.php?page=<?php print($_REQUEST['page']); ?>&back=stock">รายงานการเคลื่อนไหว</a></li>
                                        <li><a href="stock-report.php?reportType=3&page=<?php print($_REQUEST['page']); ?>&back=stock">รายงานสินค้าคงคลัง</a></li>
                                        <li><a href="stock-report.php?reportType=2&page=<?php print($_REQUEST['page']); ?>&back=stock">รายงานรายการซื้อสินค้า</a></li>
                                        <li><a href="stock-report.php?reportType=4&page=<?php print($_REQUEST['page']); ?>&back=stock">รายงานการใช้สินค้า</a></li>
                                        <li><a href="sell-report.php?page=<?php print($_REQUEST['page']); ?>&back=stock">รายงานการขายสินค้า</a></li>
                                        <li><a href="saletax-report.php?page=<?php print($_REQUEST['page']); ?>&back=stock">รายงานภาษีซื้อ</a></li>
                                        <li><a href="product_invoice.php?back=stock">รายงานภาษีขาย</a></li>
                                        <li><a href="stock-income.php?back=stock">รายงานกำไร/ขาดทุนประจำวัน</a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="table-responsive">
                                <input type="hidden" id="submitTo" value="stock.php">
                                <input type="hidden" id="backPage" name="backPage" value="stock.php">
                                <table class="td_center table table-condensed table-striped table-default table_border">
                                    ...
                                    <?php
                                    $sqlProduct="SELECT ProductID, Code, Name, AvgCost, SellPrice, Type, CanInvoice from ".$db_name.".products where Deleted=0 and Special=0";
                                    ...
                                    while($Product=mysql_fetch_row($rsProduct)){
                                        ...
                                        <tr id="item-'.$Product[0].'">
                                            ...
                                            <td>
                                                <a href="stock.php?UpdateItem='.$Product[0].'&page='.$_REQUEST['page'].'">'.$Product[1].'</a>
                                            </td>
                            ...
                            if($ProductNum > $ItemPerPage){
                                ...
                                print("<br>");
                                if($_REQUEST['page']!=1){
                                    print('<a href="stock.php?page='.($_REQUEST['page']-1).'" style="border:1px solid #CCCCCC;">&nbsp;&laquo;&laquo;&nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;');
                                }
                                print("<select onchange=\"javascript:location.href='stock.php?page='+this.value;\" name=\"setcustompage\" class=\"form-control inline_input\" style=\"width:100px;\">");
                                // all order page
                                for($i=1; $i<=$AllPage; $i++){
                                ...
                                if($_REQUEST['page']!=$AllPage){
                                    print('<a href="stock.php?page='.($_REQUEST['page']+1).'" style="border:1px solid #CCCCCC;">&nbsp;&raquo;&raquo;&nbsp;</a>');
                                }
                            }
                            ?>
                            <!-- FULL FUNCTION TABLE -->
